...
#define ACCDET_AUXADC_CTL_SET	 ACCDET_BASE + 0x0EB4 // 6325
#define ACCDET_AUXADC_REG	     ACCDET_BASE + 0x0E54
#define ACCDET_AUXADC_AUTO_SPL   ACCDET_BASE + 0x0E24

#define ACCDET_ADC_REG 			 ACCDET_BASE + 0x0D02 // 6325, need to modify the init setting & sync with audio driver

//Register value define

#define ACCDET_AUXADC_AUTO_SET   (1<<9)
#define ACCDET_DATA_READY        (1<<15)
#define ACCDET_CH_REQ_EN         (1<<8)  // 6325
...
#define ACCDET_EINT_EN           (1<<2) // 6325
#define ACCDET_NEGV_EN           (1<<4) // 6325
...
#define ACCDET_RESET_SET          (1<<4) // 6325
#define ACCDET_RESET_CLR          (1<<4) // 6325
...
#define RG_ACCDET_IRQ_SET        (1<<12) // 6325
#define RG_ACCDET_IRQ_CLR        (1<<12) // 6325
#define RG_ACCDET_IRQ_STATUS_CLR (1<<12) // 6325

#define RG_ACCDET_EINT_IRQ_SET        (1<<13) // 6325
#define RG_ACCDET_EINT_IRQ_CLR        (1<<13) // 6325

#define RG_ACCDET_NEGV_IRQ_SET        (1<<14) // 6325
#define RG_ACCDET_NEGV_IRQ_CLR        (1<<14) // 6325
#define RG_ACCDET_NEGV_IRQ_STATUS_CLR (1<<14) // 6325

//CLOCK
#define RG_ACCDET_CLK_SET        (1<<9) // 6325
#define RG_ACCDET_CLK_CLR        (1<<9) // 6325
