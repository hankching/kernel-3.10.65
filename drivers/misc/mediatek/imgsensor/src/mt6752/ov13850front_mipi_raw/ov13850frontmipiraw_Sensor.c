...
#include "ov13850frontmipiraw_Sensor.h"

#define PFX "OV13850front_camera_sensor"
#define LOG_1 LOG_INF("OV13850front,MIPI 4LANE\n")
...
static imgsensor_info_struct imgsensor_info = {
    .sensor_id = OV13850FRONT_SENSOR_ID,        
...
static int ov13850front_sysfs_init(void);
...
static kal_uint32 return_sensor_id()
{
    ...
    LOG_INF("xxxxfront driver  g_invokeSocketIdx[0] %d \n",g_invokeSocketIdx[0]);
    if(g_invokeSocketIdx[0] == DUAL_CAMERA_SUB_SENSOR || g_invokeSocketIdx[1] == DUAL_CAMERA_SUB_SENSOR){
    LOG_INF("kkkkkkkkkfront driver  g_invokeSocketIdx[0] %d \n",g_invokeSocketIdx[0]);
        return cmos_id +1;
    }else{
        return 0x0000;
    }
